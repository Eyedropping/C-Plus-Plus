...
// here I debug some code - find the solutions in the comments section

int main() // main() name was intentianally capitalized
{

    srand(time(NULL));
    int fortune = rand() % 10;

    if (fortune == 0) // equation mark was missed
    {
    ...
    else if (fortune == 5) // letter missed
    {
